...
declare namespace $ {
    ...
    class $conduit_domain extends $mol_object {
        ...
        static articles(tag?: string): $conduit_article[];
        static tags(): string[];
        static article(slug: string, article?: Partial<$conduit_article>, force?: $mol_atom_force_update): $conduit_article;
        static person_current(): $conduit_person;
        static comments(slug: string): $conduit_comment[];
        static comment_add(slug: string, comment: Partial<$conduit_comment>, force?: $mol_atom_force_update): Partial<$conduit_comment>;
        static article_save(article: Partial<$conduit_article>, force?: $mol_atom_force_update): Partial<$conduit_article>;
        static sign_in(creds: {
            email: string;
            password: string;
        }, force?: $mol_atom_force_update): any;
...
declare namespace $ {
    class $conduit_sign_in extends $mol_page {
        ...
        Pass_name(): string;
        Pass(): $mol_string;
        pass(val?: any, force?: $mol_atom_force): any;
        Auth(): $mol_button_major;
        Auth_label(): string;
        auth(val?: any, force?: $mol_atom_force): any;
        Auth_status(): $mol_status;
    }
}
declare namespace $.$$ {
...
declare namespace $ {
    class $mol_textarea extends $mol_scroll {
        ...
        event_change(event?: any, force?: $mol_atom_force): any;
        event_key_press(event?: any, force?: $mol_atom_force): any;
        event_paste(event?: any, force?: $mol_atom_force): any;
        sub_visible(): any[];
        sub(): any[];
        value_changed(val?: any, force?: $mol_atom_force): any;
        value(val?: any, force?: $mol_atom_force): any;
...
declare namespace $.$$ {
    class $mol_textarea extends $.$mol_textarea {
        event_change(next?: Event): void;
        event_key_press(next?: KeyboardEvent): void;
        event_paste(event?: ClipboardEvent): void;
        insert(injection: string): void;
        _timer: number;
        commit(): void;
        enabled(): boolean;
        value_changed(next?: string): any;
    }
}
declare namespace $ {
...
declare namespace $ {
    class $conduit_feed_page extends $mol_page {
        ...
        article_links(): any[];
        Article_link(index: any): $mol_link;
        article_slug(index: any): string;
        Article_card(index: any): $conduit_article_card;
        article(index: any): $conduit_article;
    }
}
declare namespace $.$$ {
    class $conduit_feed_page extends $.$conduit_feed_page {
        ...
        article(index: number): $conduit_article;
        body_scroll_top(val?: number, force?: $mol_atom_force): number;
    }
}
declare namespace $ {
...
declare namespace $ {
    class $conduit_comment_add extends $mol_bar {
        ...
        post(val?: any, force?: $mol_atom_force): any;
        postable(): boolean;
    }
}
declare namespace $.$$ {
...
declare namespace $ {
    class $conduit_article_page extends $mol_page {
        ...
        Comments(): $mol_list;
        comment_cards(): any[];
        Comment_add(): $conduit_comment_add;
        article(): $conduit_article;
        Comment_card(index: any): $conduit_comment_card;
        comment(index: any): $conduit_comment;
        Tag_link(index: any): $mol_link;
        tag_name(index: any): string;
    }
}
declare namespace $.$$ {
    class $conduit_article_page extends $.$conduit_article_page {
        ...
        content(): string;
        title(): string;
        comments(): $conduit_comment[];
        comment_cards(): $.$conduit_comment_card[];
        comment(index: number): $conduit_comment;
        tags(): $.$mol_link[];
        tag_name(index: number): string;
    }
}
...
declare namespace $.$$ {
    class $conduit extends $.$conduit {
        ...
        sign(): string;
        signed(): boolean;
        pages(): ($.$conduit_sign_in | $.$conduit_article_edit | $.$conduit_menu_page | $.$conduit_feed_page | $.$conduit_article_page)[];
    }
}

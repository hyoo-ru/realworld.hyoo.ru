...
(function ($) {
    class $hyoo_realworld_transport extends $.$mol_object2 {
        ...
        static headers() {
            ...
            if (!token)
                return headers;
            return Object.assign(Object.assign({}, headers), { 'Authorization': `Token ${token}` });
        }
        static load(path) {
...
(function ($) {
    ...
    class $hyoo_realworld_article extends $.$mol_object2 {
        ...
        author() {
            var _a;
            const id = (_a = this.json()) === null || _a === void 0 ? void 0 : _a.author.username;
...
(function ($) {
    ...
    (function ($$) {
        class $hyoo_realworld_article_edit extends $.$hyoo_realworld_article_edit {
            ...
            article_tags(next) {
                var _a;
                return next === undefined ? (((_a = this.article()) === null || _a === void 0 ? void 0 : _a.tags().join(', ')) || '') : next;
            }
            save(next) {
                var _a;
                if (!next)
            ...
            saveable() {
                ...
                if (this.article_content() !== ((_c = this.article()) === null || _c === void 0 ? void 0 : _c.body()))
                    return true;
                if (this.article_tags() !== ((_d = this.article()) === null || _d === void 0 ? void 0 : _d.tags().join(', ')))
                    return true;
                return false;
            }
        }
...
(function ($) {
    ...
    (function ($$) {
        class $hyoo_realworld extends $.$hyoo_realworld {
            article_current() {
                var _a;
                return this.Article((_a = this.article()) === null || _a === void 0 ? void 0 : _a.slug);
            }
            feed_current() {
            ...
            edit_current() {
                var _a;
                return this.Article_edit((_a = this.article()) === null || _a === void 0 ? void 0 : _a.slug);
            }
            article() {
                const slug = this.$.$mol_state_arg.value('article');
                if (!slug)
